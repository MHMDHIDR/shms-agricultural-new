...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ref={ref}
      data-sidebar="rail"
      aria-label="أفتح أو اغلق الشريط الجانبي"
      tabIndex={-1}
      onClick={toggleSidebar}
      title="أفتح أو اغلق الشريط الجانبي"
      className={cn(
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-0 overflow-auto pt-20 group-data-[collapsible=icon]:overflow-hidden",
        className,
      )}
      {...props}
    />
